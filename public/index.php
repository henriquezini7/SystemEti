...
// Celular abre o APP mobile; computador abre o SISTEMA (painel). Mesmos dados.
if (is_mobile() && empty($_GET['painel'])) {
    redirect(auth_user() ? 'home.php' : 'entrar.php');
}
$user = require_login();
...
<div class="panel-card today-strip">
    <div>
        ...
        <p>Todas as etiquetas importadas dos PDFs entram como pendentes até serem bipadas no despacho. O app de celular usa estes mesmos dados.</p>
    </div>
    <div class="mini-metrics inline">
    ...
    <div class="hero-actions">
        ...
        <a class="btn btn-light" href="home.php">📱 Abrir app mobile</a>
    </div>
</div>
